...
import 'package:delivery_app/features/favorit/domain/usecases/add_item_to_group_favorit/add_item_group_favorit.dart';
import 'package:delivery_app/features/favorit/domain/usecases/change_group_name_favorit/change_group_name_favorit.dart';
import 'package:delivery_app/features/favorit/domain/usecases/check_item_is_exist/check_item_is_exist.dart';
import 'package:delivery_app/features/favorit/domain/usecases/create_new_group_favorit/create_new_group_favorit.dart';
import 'package:delivery_app/features/favorit/domain/usecases/get_list_favorit/get_list_favorit.dart';
import 'package:delivery_app/features/favorit/domain/usecases/remove_group_favorit/remove_group_favorit.dart';
import 'package:delivery_app/features/favorit/domain/usecases/remove_item_from_group_favorit/remove_item_from_group_favorit.dart';
...
class FavoriteBloc extends Bloc<FavoriteEvent, FavoriteState> {
  final GetListFavorit getListFavorit =
      GetListFavorit(inject.get<FavoriteRespositoriesImpl>());
  final CreateNewGroupFavorit createNewGroupFavorit =
      CreateNewGroupFavorit(inject.get<FavoriteRespositoriesImpl>());
  final RemoveDataGroupFavorit removeDataGroupFavorit =
      RemoveDataGroupFavorit(inject.get<FavoriteRespositoriesImpl>());
  final ChangeGroupNameFavorit changeGroupNameFavorit =
      ChangeGroupNameFavorit(inject.get<FavoriteRespositoriesImpl>());
  final AddItemGroupFavorit addItemGroupFavorit =
      AddItemGroupFavorit(inject.get<FavoriteRespositoriesImpl>());
  final RemoveItemFromGroupFavorit removeItemFromGroupFavorit =
      RemoveItemFromGroupFavorit(inject.get<FavoriteRespositoriesImpl>());
  final CheckItemIsExist checkItemIsExist =
      CheckItemIsExist(inject.get<FavoriteRespositoriesImpl>());
